...
// import { ReactComponent as ParticlesSvg } from '../assets/404/particles.png'
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          ...
          &nbsp;<Typography variant="span" sx={{ color: '#fdba26', fontWeight: 500 }}>Thunio</Typography>?<br />Hmm, looks like that page doesn&apos;t exist.
        </Typography>
